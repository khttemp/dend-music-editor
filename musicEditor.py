...
startLb = ttk.Label(playerLf, text="start", font=("", 20), relief="groove", anchor=tkinter.CENTER)
startLb.place(relx=0.03, rely=0.1, relwidth=0.1, relheight=0.205)
v_start = tkinter.DoubleVar()
v_start.set(0.0)
startEt = ttk.Entry(playerLf, textvariable=v_start, font=("", 20), justify=tkinter.CENTER)
startEt.place(relx=0.13, rely=0.1, relwidth=0.13, relheight=0.2)

loopStartLb = ttk.Label(playerLf, text="loop start", font=("", 20), relief="groove", anchor=tkinter.CENTER)
loopStartLb.place(relx=0.31, rely=0.1, relwidth=0.18, relheight=0.205)
v_loopStart = tkinter.DoubleVar()
v_loopStart.set(0.0)
loopStartEt = ttk.Entry(playerLf, textvariable=v_loopStart, font=("", 20), justify=tkinter.CENTER)
loopStartEt.place(relx=0.49, rely=0.1, relwidth=0.13, relheight=0.2)

loopEndLb = ttk.Label(playerLf, text="loop end", font=("", 20), relief="groove", anchor=tkinter.CENTER)
loopEndLb.place(relx=0.66, rely=0.1, relwidth=0.18, relheight=0.205)
v_loopEnd = tkinter.DoubleVar()
v_loopEnd.set(-1.0)
loopEndEt = ttk.Entry(playerLf, textvariable=v_loopEnd, font=("", 20), justify=tkinter.CENTER)
...
v_readBgm = tkinter.StringVar()
bgmPlayNameLb = ttk.Label(playerLf, textvariable=v_readBgm, font=("", 14), relief="groove", anchor=tkinter.CENTER)
